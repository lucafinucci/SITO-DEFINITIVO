...
export default function ArticleAIHumanCentered() {
  ...
  useEffect(() => {
    ...
    fetch('/blog/ai-human-centered-potenziare-persone-non-sostituirle.html')
      .then(r => r.text())
      .then(html => {
          ...
          <div className="relative overflow-hidden border-b border-border/40">
            ...
            <div className="relative mx-auto max-w-3xl px-4 py-14 sm:py-20 text-center">
              ...
              <h1 className="mb-5 text-3xl font-bold leading-tight text-foreground sm:text-4xl lg:text-[2.6rem]">
                AI Human-Centered: Potenziare le Persone, Non Sostituirle
              </h1>
              <p className="mx-auto mb-7 max-w-2xl text-lg text-muted-foreground">
                La filosofia Human-Centered di FinCh-AI: l'intelligenza artificiale come alleata della produttività umana, non come sostituta.
              </p>
              <p className="text-sm text-muted-foreground/60">
                17 marzo 2026 &nbsp;·&nbsp; FinCh-Ai &nbsp;·&nbsp; ~10 min lettura
              </p>
            </div>
          </div>
