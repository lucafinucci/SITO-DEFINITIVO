  ...
  it: {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          [
            "Cookie tecnici/necessari: indispensabili per il corretto funzionamento del sito (es. preferenze di lingua e tema). Non richiedono consenso.",
            "Cookie analitici: utilizzati per raccogliere informazioni statistiche e anonime sull'uso del sito, al fine di migliorarne i contenuti. Vengono installati solo previo consenso.",
            "Cookie di terze parti: eventualmente impostati da servizi esterni (es. video incorporati, social network) quando interagisci con tali contenuti.",
          ],
        ],
      },
      {
        ...
        blocks: [
          "Puoi gestire o disabilitare i cookie in qualsiasi momento dalle impostazioni del tuo browser. La disattivazione dei cookie tecnici potrebbe compromettere alcune funzionalità del sito.",
          "Le principali guide per la gestione dei cookie sono disponibili nelle pagine di supporto dei browser (Chrome, Firefox, Safari, Edge).",
        ],
      },
      {
  ...
  en: {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          [
            "Strictly necessary cookies: essential for the proper functioning of the site (e.g. language and theme preferences). They do not require consent.",
            "Analytics cookies: used to collect anonymous statistical information about how the site is used, in order to improve its content. They are only set with consent.",
            "Third-party cookies: possibly set by external services (e.g. embedded videos, social networks) when you interact with such content.",
          ],
        ],
      },
      {
        ...
        blocks: [
          "You can manage or disable cookies at any time through your browser settings. Disabling necessary cookies may affect some features of the website.",
          "The main guides for managing cookies are available on the support pages of each browser (Chrome, Firefox, Safari, Edge).",
        ],
      },
      {
        heading: "4. Controller and contacts",
        blocks: [
