...
export default function ArticleSupportoDecisionaleSynapse() {
  ...
  useEffect(() => {
    ...
    fetch('/blog/sistema-supporto-decisionale-ai-pmi-synapse.html')
      .then(r => r.text())
      .then(html => {
      ...
      {loading ? (
        ...
        <>
          ...
          <div className="relative overflow-hidden border-b border-border/40">
            ...
            <div className="relative mx-auto max-w-3xl px-4 py-14 sm:py-20 text-center">
              ...
              <h1 className="mb-5 text-3xl font-bold leading-tight text-foreground sm:text-4xl lg:text-[2.6rem]">
                Il Sistema di Supporto Decisionale che costruisce la tua memoria aziendale
              </h1>
              <p className="mx-auto mb-7 max-w-2xl text-lg text-muted-foreground">
                Come un DSS evoluto basato su AI trasforma documenti sparsi, email e contratti in un database vivo della tua PMI, con risposte verificabili e human-in-the-loop.
              </p>
              <p className="text-sm text-muted-foreground/60">
                18 Maggio 2026 &nbsp;·&nbsp; FinCh-Ai &nbsp;·&nbsp; ~12 min lettura
              </p>
            </div>
          </div>
          ...
          <style>{`
            ...
            html.dark .highlight-box, html.dark blockquote, html.dark .info-box, html.dark .warning-box { background: linear-gradient(135deg, #0f1d2e 0%, #0a1a1a 100%) !important; color: #e2e8f0 !important; }
            html.dark .highlight-box p, html.dark blockquote p, html.dark .info-box p, html.dark .warning-box p { color: #cbd5e1 !important; }
