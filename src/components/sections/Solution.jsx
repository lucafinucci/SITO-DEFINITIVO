export default function Solution() {
    return (
        <section id="soluzioni" className="py-24 bg-gradient-to-b from-slate-900/50 to-transparent relative overflow-hidden">
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative">
                ...
                <div className="grid gap-12 lg:grid-cols-2 items-center mb-16">
                    <div className="space-y-8">
                        <div className="relative pl-8 border-l-4 border-cyan-500 transition-all hover:bg-slate-800/30 p-4 rounded-r-xl">
                        ...
                        <div className="relative pl-8 border-l-4 border-blue-500 transition-all hover:bg-slate-800/30 p-4 rounded-r-xl">
                            <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                        ...
                        <div className="relative pl-8 border-l-4 border-emerald-500 transition-all hover:bg-slate-800/30 p-4 rounded-r-xl">
                            <h3 className="text-xl sm:text-2xl font-bold text-white mb-3">
                    ...
                    <div className="relative">
                        ...
                        <div className="relative rounded-2xl border border-cyan-500/30 bg-slate-900/80 backdrop-blur p-8 lg:p-10 shadow-2xl">
                            <h4 className="text-2xl font-bold text-white mb-8 border-b border-slate-700/50 pb-4">Benefici Immediati</h4>
                            <div className="space-y-6">
                                {[
                                    ...
                                    <div key={i} className="flex items-center gap-5 p-4 rounded-xl bg-slate-800/50 border border-slate-700/40 hover:border-cyan-500/30 transition-colors">
                                        <div className="text-3xl font-bold text-cyan-400 min-w-[3.5rem]">{item.metric}</div>
                                        <div className="text-sm sm:text-base text-slate-300">{item.label}</div>
                                    </div>
                                ))}
                            </div>
                        </div>
