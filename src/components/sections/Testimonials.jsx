        ...
        <section id="case-studies" className="py-24 relative">
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 relative">
                ...
                <div className="space-y-12">
                        ...
                        <div className="relative p-8 sm:p-10 lg:p-12">
                            <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
                                <div className="lg:col-span-2 space-y-8">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-white mb-3 text-red-300/90">Il Problema</h4>
                                    ...
                                    <div>
                                        <h4 className="text-lg font-semibold text-white mb-3 text-emerald-300/90">La Soluzione Finch-AI</h4>
                                ...
                                <div className="space-y-4">
                                    <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-6 backdrop-blur-sm">
                                        ...
                                        <div className="text-sm text-slate-300 font-medium">Riduzione tempo elaborazione DDT</div>
                                    </div>
                                    <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-6 backdrop-blur-sm">
                                        <div className="text-4xl font-bold text-emerald-400 mb-2">2.5 FTE</div>
                                        <div className="text-sm text-slate-300 font-medium">Risorse liberate</div>
                                    </div>
                                    <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-6 backdrop-blur-sm">
                                        <div className="text-4xl font-bold text-emerald-400 mb-2">4 sett</div>
                                        <div className="text-sm text-slate-300 font-medium">Tempo di deployment</div>
                                    </div>
                                    <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-6 backdrop-blur-sm">
                                        <div className="text-4xl font-bold text-emerald-400 mb-2">ROI 6m</div>
                                        <div className="text-sm text-slate-300 font-medium">Break-even raggiunto</div>
                                    </div>
                                </div>
                            </div>

                            <div className="mt-10 pt-8 border-t border-slate-700/50">
                                <blockquote className="italic text-slate-300/90 text-lg leading-relaxed">
                                ...
                                <div className="mt-4 flex items-center gap-3">
                                    <div className="h-10 w-10 rounded-full bg-cyan-500/20 flex items-center justify-center text-cyan-400 font-bold">M</div>
                                    <div>
                                        <div className="text-sm font-semibold text-white">Marco R.</div>
                    ...
                    <div className="relative overflow-hidden rounded-3xl border border-slate-700/60 bg-gradient-to-br from-slate-900/60 to-slate-900/40 backdrop-blur p-8 sm:p-12 text-center">
                        <h3 className="text-2xl font-bold text-white mb-4">La tua azienda potrebbe essere la prossima success story</h3>
                        <p className="text-slate-300/90 max-w-2xl mx-auto mb-8">
