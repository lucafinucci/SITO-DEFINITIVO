                ...
                <div className="space-y-12">
                        ...
                        <div className="relative grid lg:grid-cols-2 gap-8 items-center">
                            <div>
                                <div className="inline-flex items-center gap-3 mb-6">
                                    <div className="rounded-xl border border-cyan-500/30 bg-cyan-500/10 p-3 text-cyan-300 shadow-lg shadow-cyan-500/10">
                            ...
                            <div className="space-y-4">
                                <div className="rounded-2xl border border-cyan-500/30 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 p-6 backdrop-blur-sm">
                                    <div className="text-4xl font-bold text-cyan-400 mb-2">90%</div>
                                    <div className="text-sm text-slate-300 font-medium">Riduzione tempo elaborazione documenti</div>
                                </div>
                                <div className="rounded-2xl border border-cyan-500/30 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 p-6 backdrop-blur-sm">
                                    <div className="text-4xl font-bold text-cyan-400 mb-2">99.2%</div>
                                    <div className="text-sm text-slate-300 font-medium">Accuratezza estrazione dati</div>
                                </div>
                                <div className="rounded-2xl border border-cyan-500/30 bg-gradient-to-br from-cyan-500/10 to-blue-500/10 p-6 backdrop-blur-sm">
                                    <div className="text-4xl font-bold text-cyan-400 mb-2">Zero</div>
                                    <div className="text-sm text-slate-300 font-medium">Data entry manuale richiesto</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="group relative overflow-hidden rounded-3xl border border-slate-700/60 bg-slate-900/40 p-8 sm:p-10 backdrop-blur transition hover:border-purple-500/50 hover:shadow-[0_0_40px_rgba(168,85,247,0.2)]">
                        ...
                        <div className="relative grid lg:grid-cols-2 gap-8 items-center">
                            <div className="order-2 lg:order-1 space-y-4">
                                <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-br from-purple-500/10 to-pink-500/10 p-6 backdrop-blur-sm">
                                    <div className="text-4xl font-bold text-purple-400 mb-2">Real-time</div>
                                    <div className="text-sm text-slate-300 font-medium">Monitoraggio OEE e produttività</div>
                                </div>
                                <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-br from-purple-500/10 to-pink-500/10 p-6 backdrop-blur-sm">
                                    <div className="text-4xl font-bold text-purple-400 mb-2">3x</div>
                                    <div className="text-sm text-slate-300 font-medium">Velocità decisioni strategiche</div>
                                </div>
                                <div className="rounded-2xl border border-purple-500/30 bg-gradient-to-br from-purple-500/10 to-pink-500/10 p-6 backdrop-blur-sm">
                                    <div className="text-4xl font-bold text-purple-400 mb-2">100%</div>
                                    <div className="text-sm text-slate-300 font-medium">Visibilità su tutti i reparti</div>
                                </div>
                            </div>

                            <div className="order-1 lg:order-2">
                                <div className="inline-flex items-center gap-3 mb-6">
                                    <div className="rounded-xl border border-purple-500/30 bg-purple-500/10 p-3 text-purple-300 shadow-lg shadow-purple-500/10">
                    ...
                    <div className="group relative overflow-hidden rounded-3xl border border-slate-700/60 bg-slate-900/40 p-8 sm:p-10 backdrop-blur transition hover:border-emerald-500/50 hover:shadow-[0_0_40px_rgba(16,185,129,0.2)]">
                        ...
                        <div className="relative grid lg:grid-cols-2 gap-8 items-center">
                            <div>
                                <div className="inline-flex items-center gap-3 mb-6">
                                    <div className="rounded-xl border border-emerald-500/30 bg-emerald-500/10 p-3 text-emerald-300 shadow-lg shadow-emerald-500/10">
                            ...
                            <div className="space-y-4">
                                <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-6 backdrop-blur-sm">
                                    <div className="text-4xl font-bold text-emerald-400 mb-2">Zero</div>
                                    <div className="text-sm text-slate-300 font-medium">Attrito nelle integrazioni</div>
                                </div>
                                <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-6 backdrop-blur-sm">
                                    <div className="text-4xl font-bold text-emerald-400 mb-2">100%</div>
                                    <div className="text-sm text-slate-300 font-medium">Sincronizzazione automatica</div>
                                </div>
                                <div className="rounded-2xl border border-emerald-500/30 bg-gradient-to-br from-emerald-500/10 to-teal-500/10 p-6 backdrop-blur-sm">
                                    <div className="text-4xl font-bold text-emerald-400 mb-2">24/7</div>
                                    <div className="text-sm text-slate-300 font-medium">Controllo finanziario operativo</div>
                                </div>
                            </div>
                        </div>
                    </div>
